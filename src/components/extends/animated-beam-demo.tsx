...
export function AnimatedBeamDemo1() {
...
export function AnimatedBeamDemo3() {
  const containerRef = useRef<HTMLDivElement>(null);
  const div1Ref = useRef<HTMLDivElement>(null);
  const div2Ref = useRef<HTMLDivElement>(null);
  return (
...
export function AnimatedBeamMultipleOutputDemo4({
  className,
}: {
  className?: string;
}) {
...
export function AnimatedBeamMultipleOutputDemo5({
  className,
}: {
  className?: string;
}) {
...
export function GlobeDemo() {
  return (
    <div className='bg-background relative flex size-full items-center justify-center overflow-hidden px-40 pt-8 pb-40 md:pb-60'>
