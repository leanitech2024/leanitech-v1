...
function TimeUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className='flex flex-col items-center gap-2'>
      <div className='relative flex items-center justify-center bg-secondary/50 backdrop-blur-sm border border-border/50 rounded-xl px-4 py-3 md:px-6 md:py-5 min-w-20 md:min-w-25 shadow-sm overflow-hidden group'>
  ...
  return (
    <section className='relative w-full px-4 py-12 md:py-24 overflow-hidden flex items-center justify-center min-h-screen bg-background'>
      ...
      <div className='absolute inset-0 flex items-center justify-center pointer-events-none'>
        <div className='absolute w-200 h-150 bg-primary/5 rounded-full blur-3xl -top-1/2 -left-1/4' />
        <div className='absolute w-150 h-150 bg-secondary/20 rounded-full blur-3xl bottom-0 right-0' />
      </div>
        ...
        <motion.div
          ...
          <div className='flex items-center gap-2 md:gap-4 relative z-10'>
            ...
            <div className='flex flex-col items-center justify-center pb-6'>
              <span className='text-2xl md:text-4xl font-light text-muted-foreground/50 animate-pulse'>
                :
              </span>
            </div>
