...
export default function WorldMap({
  ...
  /*
  The class `[mask-image:linear-gradient(to_bottom,transparent,white_10%,white_90%,transparent)]` can be written as `mask-[linear-gradient(to_bottom,transparent,white_10%,white_90%,transparent)]`
  */

  return (
    <div className='w-full aspect-2/1 md:aspect-2.5/1 lg:aspect-2/1 bg-muted-background rounded-lg relative font-sans overflow-hidden'>
      <Image
