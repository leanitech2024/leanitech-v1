...
function Services2({ data = servicesData }: ServicesProps) {
        ...
        <div className='flex flex-col sm:gap-16 gap-8'>
          <div className='flex md:flex-row flex-col justify-between md:items-end items-start gap-4'>
            <div className='flex flex-col gap-4 animate-in fade-in slide-in-from-left-10 duration-1000 delay-200 ease-in-out fill-mode-both'>
              <Badge
                variant='outline'
                className='py-1 px-3 h-auto text-sm font-normal border-0 outline outline-border'>
                Services
              </Badge>
            ...
            <Button
              className={
                'group p-1 bg-primary text-white font-medium flex gap-2 lg:gap-3 justify-between items-center rounded-full w-fit ps-5 h-auto border-0 animate-in fade-in slide-in-from-right-10 duration-1000 delay-200 ease-in-out fill-mode-both'
              }>
              <a
                href='#'
              ...
              <div>
                {data?.map((value, index) => (
                  <div
                    ...
                    <h3
                      className={cn(
                        'group-hover:text-teal-400 py-1 text-3xl font-semibold text-foreground max-w-2xs w-full',
