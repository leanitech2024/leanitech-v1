...
//     tokenBucket({
//       mode: 'LIVE', // Blocks requests. Use "DRY_RUN" to log only
//       refillRate: 2000, // Refill 2,000 tokens per hour
//       interval: '1h',
//       capacity: 5000, // Maximum 5,000 tokens in the bucket
//     }),
...
const aj = arcjet
  ...
  .withRule(
    ...
    tokenBucket({
      mode: 'LIVE', // Blocks requests. Use "DRY_RUN" to log only
      refillRate: 2, // Refill 2,000 tokens per hour
      interval: '1m',
      capacity: 2, // Maximum 5,000 tokens in the bucket
    }),
  )
  // .withRule(
  //   // Alternative rate limit strategy using a fixed window. Adjust as needed.
  //   fixedWindow({
  //     mode: 'LIVE',
  //     max: 2,
  //     window: '60s',
