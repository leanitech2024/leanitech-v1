...
export default function AboutPage() {
  ...
  return (
    <main className={'relative'}>
      ...
      <section className={sectionClasses}>
        <Card
          className={cn('grid grid-cols-1 lg:grid-cols-2 gap-4', cardClasses)}>
          <Card className={'px-0 w-full h-full grid content-center'}>
            <CardContent className={'space-y-6'}>
              ...
              <p>
                ...
                dedication to our customers. Over the years, Metafi has evolved
                into a leading provider of financial solutions, constantly
                adapting to meet the ever-changing needs of businesses
                worldwide. Our success is not just measured in years but in the
                tangible impact we&apos;ve made, backed by concrete data and
                statistics that validate our journey.
              </p>

              <p>
                With a proven track record of delivering results, Metafi stands
                as a testament to our commitment to excellence and continuous
                improvement. Our growth trajectory is marked by milestones, each
                supported by solid numbers that underscore our achievements and
                validate our position as a trusted partner in the financial
                industry.
              </p>
