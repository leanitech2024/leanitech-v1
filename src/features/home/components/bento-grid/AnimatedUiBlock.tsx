      ...
      <div className='min-h-[216px] flex items-center justify-center relative'>
        ...
        <motion.div
          ...
          <span
            ...
            className='lg:size-18 size-11 flex items-center justify-center rounded-full bg-background'>
        ...
        <motion.div
          ...
          <span
            ...
            className='lg:size-12 size-7 flex items-center justify-center rounded-full bg-background'>
            <Command size={24} />
          </span>
        </motion.div>
        <motion.div
